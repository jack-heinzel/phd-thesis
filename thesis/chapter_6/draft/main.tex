...
%% Chapter appendix sections (note: \appendix below affects global chapter numbering;
%% since this is the last chapter, it is safe — the MIT-Thesis.tex \appendix follows.)
\appendix
