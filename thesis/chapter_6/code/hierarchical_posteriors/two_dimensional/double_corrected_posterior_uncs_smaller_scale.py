...
for npe in npelist:
    ...
    os.makedirs(f'double_corrected_data_smaller/Ndim{ndim}_N{Nobs}_posteriors/', exist_ok=True)
    with open(f'double_corrected_data_smaller/Ndim{ndim}_N{Nobs}_posteriors/npe_{npe}.pkl', 'wb') as ff:
