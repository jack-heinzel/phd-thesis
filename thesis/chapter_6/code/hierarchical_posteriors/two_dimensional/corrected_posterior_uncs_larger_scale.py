...
for npe in npelist:
    ...
    # @jax.jit
    if npe <= 10:
        sigmas = jnp.linspace(-0.1,0.3,101)
    else:
        sigmas = jnp.linspace(-0.1,0.2,41)
    mus = jnp.linspace(0.85,1.05,41)
    ...
    os.makedirs(f'../../../data/two_dimensional/corrected_data/large_noise_Ndim{ndim}_N{Nobs}_posteriors/', exist_ok=True)
    os.makedirs(f'../../../data/two_dimensional/corrected_data/large_noise_Ndim{ndim}_N{Nobs}_weights/', exist_ok=True)
    
    with open(f'../../../data/two_dimensional/corrected_data/large_noise_Ndim{ndim}_N{Nobs}_posteriors/{int(sys.argv[1])}_npe_{npe}.pkl', 'wb') as ff:
    ...
    with open(f'../../../data/two_dimensional/corrected_data/large_noise_Ndim{ndim}_N{Nobs}_weights/{int(sys.argv[1])}_npe_{npe}.pkl', 'wb') as ff:
