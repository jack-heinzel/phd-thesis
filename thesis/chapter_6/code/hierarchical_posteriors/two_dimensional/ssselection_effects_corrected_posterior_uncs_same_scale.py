...
nvtlist = [100_000, 500_000, 1_000_000, 5_000_000]
print(nvtlist)
for nvt in nvtlist:
    ...
    # if Nobs == 1000:
    sigmas = jnp.linspace(-0.1,0.15,51)
    mus = jnp.linspace(0.5,1.2,51)

    sigma_analytic = jnp.linspace(-0.1,0.15,301)
    mu_analytic = jnp.linspace(0.5,1.2,301)
    # elif Nobs == 100:
    ...
    if n_repeat < 1 and len(sys.argv) > 1:
