...
\usepackage[style=ext-numeric-comp,giveninits=true,maxbibnames=10,sorting=none,language=american,natbib=true,refsection=chapter]{biblatex}
...
\addbibresource{mitthesis-sample.bib}%% kept for sample appendices
