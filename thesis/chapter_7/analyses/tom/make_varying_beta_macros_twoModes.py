...
result = PopulationResult(fname='../../../o4a-pop-studies/data/popsummary_independentMassRatio_O4_twoModes_cat_38214bd95_724.h5')
...
with open("VaryingBetaQsTwoModes.json", "w") as jf:
