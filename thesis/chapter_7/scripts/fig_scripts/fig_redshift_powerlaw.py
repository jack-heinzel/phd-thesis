...
# powerlaw_file = '/home/jacob.golomb/o4_pe/RP/aug14_plp/init/result/combined_semianalytic_mass_SinglePeakSmoothedMassDistribution_magnitude_iid_spin_magnitude_tilt_iid_spin_orientation_redshift_PowerLawRedshift_popsummary_result.h5'
# powerlaw_file = '/home/jaxen.godfrey/o4a-astro-dist/o4a-astrodist/analyses/default_bbh/popsummary/gwtc4_2pl2pk_mass_TwoPeakBrokenPowerLawSmoothedMassDistribution_magnitude_iid_spin_magnitude_gaussian_tilt_iid_spin_orientation_gaussian_isotropic_redshift_PowerLawRedshift_popsummary_result.h5'
...
gwtc3_result = bilby.core.result.read_in_result('/home/jack.heinzel/public_html/GWTC-3-population/GWTC-3-population-data/analyses/PowerLawPeak/o1o2o3_mass_c_iid_mag_iid_tilt_powerlaw_redshift_result.json')
...
ax[0].hist(kappa, bins=np.linspace(-2,6,51), density=True, color=color1, label='GWTC-4.0', edgecolor=color1, linewidth=0.01, rwidth=1.)
...
bs_file = '/home/jaxen.godfrey/o4a-astro-dist-clean/o4a-astrodist/analyses/jaxen/november2025_pe_update/result_files/dec4_bspline_iid.h5'
# plot parametric
...
plt.tight_layout()
plt.savefig('../../figures/redshift_bs_vs_powerlaw.pdf')