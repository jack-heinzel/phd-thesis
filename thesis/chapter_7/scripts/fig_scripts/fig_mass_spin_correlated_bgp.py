...
mass_spin_result = PopulationResult('/home/anarya.ray/public_html/gppop_spin_popsummary_rerun_ulogm.hdf5')
...
plt.savefig('../../figures/mass_spin_correlated_bgp_combined.pdf', bbox_inches='tight')