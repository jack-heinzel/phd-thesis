...
pdb_file = '/home/amanda.farah/projects/O4/PDB-in-O4/analysis_results/baseline6_mass_NotchFilterBinnedPairingMassDistribution_redshift_powerlaw_mag_iid_spin_magnitude_gaussian_tilt_iid_spin_orientation_medians_popsummary.h5'
pdb_result = popsummary.popresult.PopulationResult(fname=pdb_file)

bgp_file = '/home/anarya.ray/public_html/o4a_gppop_m1m2/gppop_m1m2_popsummary_ifar4_ulogm.hdf5'
...
# R = R + R.T - np.diag(R)
# rate_sample_file = '/home/amanda.farah/projects/O4/PDB-in-O4/analysis_results/baseline5_widesigmachi2_mass_NotchFilterBinnedPairingMassDistribution_redshift_powerlaw_mag_iid_spin_magnitude_gaussian_tilt_iid_spin_orientation_rate_grid.npy'
...
cbarupper = fig.colorbar(iu, cax=axes[0])#, ticks=np.logspace(np.log10(uncmin), np.log10(uncmax), nOrderunc+1))
...
cbarlower.set_label('$\\frac{\mathrm{d}^2\mathcal{R}}{\mathrm{d}(\ln m_1)\mathrm{d}(\ln m_2)}$ [Gpc${}^{-3}$ yr${}^{-1}$]', rotation=90)

#  cbarupper.ax.set_yticklabels(unc_tick_labels)
...
plt.show()
plt.savefig('../../figures/full_mass_spectrum_2d_ppd.pdf', bbox_inches='tight', dpi=200)
