...
res = PopulationResult('/home/christian.adamcewicz/public_html/o4a_astrodist/zchieffCopulaCorrelationModelPopsummaryV2.h5')
...
plt.savefig('../../figures/correlation_appendix.pdf', bbox_inches='tight')