...
sylvia_path = '../../../analyses/sylvia/popsummary_filepath_BBHSpin_MagTruncnormIidTiltIsotropicTruncnormSpinSorting.txt'
with open(sylvia_path, "r") as file:
    fname = file.read().split('\n')[0] # first line in the file
    result = PopulationResult(fname=fname)
...
plt.savefig(pf.figs_folder+'spin_sorting_traces.pdf', bbox_inches='tight')
plt.close()