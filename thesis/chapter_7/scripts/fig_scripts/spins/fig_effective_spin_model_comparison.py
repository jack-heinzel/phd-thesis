...
pf.setup()
path_folder = '../../../analyses/simona/'

'''
Setup
'''

# Get paths to popsummary files
with open(path_folder+'popsummary_filepath_BBHSpin_GaussianChiEffChiP.txt', "r") as file:
    variance_cut_path = file.read()
with open(path_folder+'popsummary_filepath_BBHSpin_GaussianChiEffChiP_NeffCut.txt', "r") as file:
    Neff_cut_path = file.read()   

# Load popsummary files
popsummary_results = {
    'variance_cut' : PopulationResult(fname=variance_cut_path),
    'Neff_cut' : PopulationResult(fname=Neff_cut_path)
}   
...
plt.savefig(pf.figs_folder+'chi_eff_chi_p_model_comparison_cornerplot.pdf', bbox_inches='tight')
plt.close()
...
plt.savefig(pf.figs_folder+'chi_eff_chi_p_model_comparison_dists.pdf', bbox_inches='tight')
plt.close()