...
# load the data
with open(f'../../../analyses/sharan/popsummary_filepath_BBHSpin_EpsSkewNormalChiEff.txt', "r") as file:
    popsummary_filepath = file.read()
skewnormal = PopulationResult(fname=popsummary_filepath.strip('\n'))
...
plt.savefig(pf.figs_folder+'chi_eff_chi_p_traces.pdf', bbox_inches='tight')
