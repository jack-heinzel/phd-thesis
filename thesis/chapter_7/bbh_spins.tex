...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/spins/spin_sorting_traces.pdf}
...
\tablehead{
    \colhead{Model} & \colhead{$\chi_{\mathrm{eff}, 1\%}$} & \colhead{Fraction $\chieff<0$} & \colhead{HM Fraction}
}
