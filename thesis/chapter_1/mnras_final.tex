...
\chapterauthors{Jack Heinzel$^{1,2}$, Colm Talbot$^{1,2}$, Gregory Ashton$^{3}$, and Salvatore Vitale$^{1,2}$}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{plots/blip_omega.pdf}
...
The data underlying this work can be found on a zenodo data release at \url{https://doi.org/10.5281/zenodo.7860652}. The public gravitational wave data can be found in the Gravitational Wave Open Science Center \citep{theligoscientificcollaboration2023open}.
